...
namespace Tests_Unitarios
{
    ...
    public class TesterMetodosDeUnPersonaje
    {
        ...
        /// <summary>
        /// Se testea la propiedad ID de un personaje. 
        /// </summary>
        [TestMethod]
        public void TesteoDePropiedadID()
        {
            //ARRANGE
            Personaje personaje1 = new Personaje("Federico", 32, Personaje.enumOrigenElemental.Agua, Arma.enumTipoArma.Arco);    

            int resultadoValidacionID;

            //ACT
            personaje1.IdPersonaje = 10;
            resultadoValidacionID = personaje1.IdPersonaje;

            //ASSERT
            Assert.AreEqual(10, resultadoValidacionID);
        }

        /// <summary>
        /// Se testea la propiedad batallas ganadadas y jugadas de un personaje.
        /// </summary>
        [TestMethod]
        public void TesteoDeBatallasGanadasYJugadas()
        {
            //ARRANGE
            Personaje personaje1 = new Personaje("Federico", 32, Personaje.enumOrigenElemental.Agua, Arma.enumTipoArma.Arco);
            Personaje personaje2 = new Personaje("Federica", 32, Personaje.enumOrigenElemental.Agua, Arma.enumTipoArma.Arco);

            personaje1.BatallasJugadas = 100;
            personaje1.BatallasGanadas = 50;

            personaje2.BatallasJugadas = 100;
            personaje2.BatallasGanadas = 50;

            int resultadoValidacionBatallasJugadasPJ1;
            int resultadoValidacionBatallasGanadasPJ1;

            int resultadoValidacionBatallasJugadasPJ2;
            int resultadoValidacionBatallasGanadasPJ2;

            //ACT
            resultadoValidacionBatallasJugadasPJ1 = personaje1.BatallasJugadas;
            resultadoValidacionBatallasGanadasPJ1 = personaje1.BatallasGanadas;

            resultadoValidacionBatallasJugadasPJ2 = personaje2.BatallasJugadas;
            resultadoValidacionBatallasGanadasPJ2 = personaje2.BatallasGanadas;

            //ASSERT
            Assert.AreEqual(100, resultadoValidacionBatallasJugadasPJ1);
            Assert.AreEqual(50, resultadoValidacionBatallasGanadasPJ1);
            Assert.AreEqual(100, resultadoValidacionBatallasJugadasPJ2);
            Assert.AreEqual(50, resultadoValidacionBatallasGanadasPJ2);
        }

        /// <summary>
        /// Se testea el constructor vacío de un personaje.
        /// </summary>
        [TestMethod]
        public void TesteoDeConstructorVacio()
        {
            //ARRANGE
            Personaje personajeVacio = new Personaje();

            //ASSERT
            Assert.IsTrue(personajeVacio != null);
        }
    }
}
