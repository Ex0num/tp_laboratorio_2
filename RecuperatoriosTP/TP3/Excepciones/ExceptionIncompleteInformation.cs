...
{
    public class ExceptionIncompleteInformation : Exception
    {
        /// <summary>
        ...
        public ExceptionIncompleteInformation(string mensaje) : this(mensaje, null)
        {
        ...
        public ExceptionIncompleteInformation(string mensaje, Exception inner) : base(mensaje, inner)
        {
