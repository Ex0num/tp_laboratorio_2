...
{
    public class ExceptionCharacterNotFound : Exception
    {
        /// <summary>
        ...
        public ExceptionCharacterNotFound(string mensaje) : this(mensaje, null)
        {
        ...
        public ExceptionCharacterNotFound(string mensaje, Exception inner) : base(mensaje, inner)
        {
