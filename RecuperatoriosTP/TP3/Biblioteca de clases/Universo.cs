...
namespace Entidades
{
    public static class Universo
    {
        ...
        public static void ObtenerWinrateArma(out Arma.enumTipoArma tipoArmasWinrate, out double winrateDelTipoArma, bool esMayorWinrate)
        {
            ...
            foreach  (Personaje personaje in Universo.listaPersonajesExistentes)
            {
                ...
                else if (personaje.Arma.TipoArma == Arma.enumTipoArma.Escudo && personaje.BatallasJugadas > 0)
                {
                    ...
                    ganadasEscudos = ganadasArcos + personaje.BatallasGanadas;
            ...
            double winrateArcos = 0;
            double winrateEscudos = 0;
            double winrateBastones = 0;
        ...
        public static void ObtenerWinratePoder(out Personaje.enumOrigenElemental tipoPoderWinrate, out double winrateDelPoder, bool esMayorWinrate)
        {
            ...
            double winrateFuego = 0;
            double winrateAgua = 0;
            double winrateHielo = 0;
        ...
        /// <summary>
        /// Método que obtiene los porcentajes de cada arma o poder, segun se indique en su parametro booleano
        ...
        public static void ObtenerPorcentajes(bool esPorcentajeArma, out double porcentaje1, out double porcentaje2, out double porcentaje3)
        {
            porcentaje1 = 0;
            porcentaje2 = 0;
            porcentaje3 = 0;
