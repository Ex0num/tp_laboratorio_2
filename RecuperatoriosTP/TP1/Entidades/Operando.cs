...
namespace Entidades
{
    public class Operando
    {
        ...
        //Arreglado -> No reutiliza los constructores(posible motivo de desaprobación).

        /// <summary>
        /// Constructor 1 de una variable operando. Por defecto este constructor asigna un valor "0" al atributo ".numero". (Llamando al builder que setea 0 al recibir un String)
        /// </summary>
        ...
        /// <summary>
        /// Constructor 2 de la variable Operando. Recibe un numero como Double y lo transforma a string para pasarselo al Contructor 3.
        /// </summary>
        /// <param name="numeroRecibido"></param>
        public Operando(double numeroRecibido)
        {
            //Si recibo un numero double, simplemente lo seteo sin necesidad de hacer una validacion y o convertirlo a String.
            this.numero = numeroRecibido;
           
        }

        /// <summary>
        /// Contructor 3 de la variable Operando. Recibe un numero como String, lo valida y lo setea en el campo numero ya convertido a double.
        /// </summary>
        /// <param name="strNumero"></param>
        public Operando(string strNumero)
        {
            //Llamo a la propiedad para validarlo y setearlo.
            Numero = strNumero;
        }
        ...
        public string BinarioDecimal(string binario)
        {
            ...
            //En la validacion binaria me encargo de validar que no solo sea un numero binario si que ademas no sea - o con .,
            if (resultadoValidacionBinario == true) 
            {
                ...
                for (int i = (binario.Length - 1); i >= 0; i--)
                {
                    ...
                    if (potenciador == 0 && numeritoBin == 0) //EXCEPTO EN ESTE CASO
                    {
                        //Porque si yo tengo   0 * 2 ^ 0  = 0  y antes en el mathpow me arruinaba el resultado dandome 1.
                    }
                    else
                    {
