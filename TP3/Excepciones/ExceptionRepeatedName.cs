...
{
    public class ExceptionRepeatedName : Exception
    {
        /// <summary>
        ...
        public ExceptionRepeatedName(string mensaje) : this(mensaje, null)
        {
        ...
        public ExceptionRepeatedName(string mensaje, Exception inner) : base(mensaje, inner)
        {
